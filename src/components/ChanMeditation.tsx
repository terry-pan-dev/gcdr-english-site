    ...
    <div className="min-h-screen bg-[#1c1917] text-[#EBE9CF]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <motion.section
          ...
          className="mb-16"
        >
          <h2 className="text-3xl md:text-4xl font-serif mb-6 text-[#c9a050]">
            What is Chan?
          </h2>
          <div className="prose prose-invert max-w-none">
            ...
            <p className="text-lg leading-relaxed mb-6 opacity-90">
              ...
              thoughts take us. Without having to pay for traveling, we can take
              a rocket trip. The false thoughts fly everywhere without
              restraint.
            </p>
            <p className="text-lg leading-relaxed mb-6 opacity-90">
              ...
              That fuel is our precious mental energy. No matter how many times
              we refuel, we keep using it up.
            </p>
            <p className="text-lg leading-relaxed mb-6 opacity-90">
              Take for example people who consume tonics everyday, thinking that
              they are replenishing their bodies with nutrients. If people do
              not treasure their mental energy and are selfindulgent, then no
              matter how much tonic they consume, they will never replenish the
              wasted energy. As a proverb says,{" "}
              ...
              know how to drive well, we will not drive around recklessly and
              meet with an accident. Our car will also last longer. Similarly,
              if we know how to take care of ourselves, then it is possible to
              neither age nor die.
            </p>
          </div>
        </motion.section>
        ...
        >
          ...
          <p className="text-lg leading-relaxed opacity-90">
            Shakyamuni Buddha initiated Chan investigation when he held aloft a
            flower in the Vulture Peak Assembly to indicate the transmission of
            the subtle and wonderful mind seal Dharma door. At that time,
        ...
        >
          ...
          <p className="text-lg leading-relaxed mb-6 opacity-90">
            Chan means stilling thoughts. We will only realize Chan if we still
            our thoughts. Samadhi means not moving. If we move, we have no
            samadhi.
          </p>
          <p className="text-lg leading-relaxed mb-6 opacity-90">
          ...
          <p className="text-lg leading-relaxed mb-6 opacity-90">
            ...
            inexplicable and indescribable. Because it surpasses what your mind
            can imagine, it is described like this:
          </p>
        ...
        >
          ...
          <p className="text-lg leading-relaxed mb-6 opacity-90">
            ...
            definition, we know that it is impossible not to have false thinking
            during Chan sitting. Normally, our false thinking comes and goes
            just like waves on water. Waves come up because of wind. When we
            meditate, why do false thoughts arise? It is because our self-nature
            still contains falsehood. This falsehood is like the wind, and false
            thoughts are like waves stirred by the wind.
          </p>
          <p className="text-lg leading-relaxed mb-6 opacity-90">
          ...
          <blockquote className="border-l-4 border-[#c9a050] pl-6 my-6 italic text-xl opacity-90">
            <p>
              In unmoving suchness where all is absolutely clear and constantly
              understood.
            </p>
          </blockquote>
          <p className="text-lg leading-relaxed mb-6 opacity-90">
          ...
          <div className="bg-white/5 p-6 rounded-lg my-6">
            <p className="text-lg leading-relaxed mb-4 opacity-90 italic">
              People may praise us or ridicule us as they wish. In favorable or
              adverse conditions, we will advance vigorously. No suffering or
              joy will move our minds.
            </p>
        ...
        >
          ...
          <p className="text-lg leading-relaxed mb-6 opacity-90">
            Investigating Chan requires non-movement of the mind and thoughts
            and this means silence. The Chan method works like the thrust of a
            knife, cutting right through. Because Chan investigation is apart
            from the mind-consciousness, it is known as putting an end to the
            mind. Ending the mind means ending all mental activities of the
            mind-consciousness. Only when all the activities of the false mind
            are stopped will thoughts be silenced. When that happens, we gain
            the power of knowing and seeing that comes with suddenly
          ...
          <ol className="list-decimal list-inside space-y-4 mb-6 text-lg opacity-90">
            <li className="mb-2">
              <strong className="text-[#c9a050]">Heat.</strong> This warm energy
              comes as we sit in meditation.
            </li>
            <li className="mb-2">
              <strong className="text-[#c9a050]">Summit.</strong> That energy
              rises to the crown of our head as we continue to practice.
            </li>
            <li className="mb-2">
              <strong className="text-[#c9a050]">Patience.</strong> It becomes
              very difficult to be patient, but we must still be patient.
            </li>
            <li className="mb-2">
              <strong className="text-[#c9a050]">First in the World.</strong> We
              become a world-transcending great hero. If we want to attain these
              four stages, we must first learn to silence the mind. Our
              mind-consciousness must remain unmoving.
            </li>
          </ol>
          <p className="text-lg leading-relaxed mb-6 opacity-90">
        ...
        >
          ...
          <p className="text-lg leading-relaxed mb-6 opacity-90">
            What is the flavor of Chan? It is the joy of realizing Chan samadhi,
            which brings a feeling of lightness and tranquility. This infinitely
            wonderful experience defies conceptualization and verbal
            description. Those who have personally experienced this state
            tacitly accept it. Just as when a person drinks water, he himself
            will know whether it is hot or cold, so too lightness and ease is
            something we ourselves will know when it happens to us. If all of
            you want to know whether the flavor of Chan is sweet or bitter, you
            will have to work very hard at investigating Chan. When you have
            reached a certain state, you will naturally know the flavor.
          </p>
          <p className="text-lg leading-relaxed mb-6 opacity-90">
            Therefore, you have to investigate, and when you have investigated
            until the truth emerges, then you will experience the flavor of
            Chan. Chan is not to be spoken of but is to be investigated. This is
            why the Chan sect does not teach using words or literature. Its
            truth is transmitted outside the Teaching. It is a method that
            points directly to the human mind so that one can see one's own
            nature and attain Buddhahood. When a person who investigates Chan
            has reached a high level of attainment, he will never get angry. He
            will not fight or contend with others, because he has attained the
            Samadhi of Non-Contention. He will not pursue fame nor gain, because
            he looks upon wealth as being dewdrops on flowers. He looks upon
            official status as being frost on a rooftop. Both vanish without a
            trace in no time.
          </p>
        </motion.section>
      </div>
      ...
      <div className="py-20 bg-[#1c1917]">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-serif mb-4 text-[#c9a050]">
            Our Sacred Spaces
          </h2>
