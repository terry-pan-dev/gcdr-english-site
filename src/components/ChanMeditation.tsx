...
const galleryItems = [
  { image: "/assets/chan-meditation/mmexport1697577219970.jpg", text: "Chan Meditation Practice" },
  { image: "/assets/chan-meditation/mmexport1697577214414.jpg", text: "Meditation Session" },
  { image: "/assets/chan-meditation/DSC2188-scaled.jpg", text: "Sacred Meditation Space" },
  { image: "/assets/chan-meditation/DSC_0152-1-scaled.jpg", text: "Peaceful Contemplation" },
  { image: "/assets/chan-meditation/DSC_1630-scaled.jpg", text: "Chan Practice" },
  { image: "/assets/chan-meditation/DSC_1495-scaled.jpg", text: "Meditation Hall" },
  { image: "/assets/chan-meditation/DSC_1480-scaled.jpg", text: "Stillness and Wisdom" },
  { image: "/assets/chan-meditation/DSC_1475-scaled.jpg", text: "Dharma Practice" },
  { image: "/assets/chan-meditation/DSC_1470-scaled.jpg", text: "Inner Peace" },
  { image: "/assets/chan-meditation/DSC_1466-scaled.jpg", text: "Chan Investigation" },
  { image: "/assets/chan-meditation/DSC_1462-scaled.jpg", text: "Meditation Path" },
  { image: "/assets/chan-meditation/DSC_0186-scaled.jpg", text: "Sacred Space" },
  { image: "/assets/chan-meditation/DSC_0296-scaled.jpg", text: "Spiritual Practice" },
];
    ...
    <div className="min-h-screen bg-[#1c1917] text-[#EBE9CF]">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        >
          ...
          <p className="text-lg leading-relaxed mb-6 opacity-90">
            By taking Dharma bliss as food, Chan samadhi will manifest. When we cultivate the Way, we practice sitting in meditation. To develop Chan, we need to sit down. As we sit in meditation, our skill will manifest. It should not be the case that as soon as you sit in meditation knowing anything at all. Entering samadhi requires one to sit in an upright posture. One sits with a straight back and holds the head straight without nodding or inclining the neck. What is meant by samadhi power? Samadhi has a certain power that supports and maintains your body in an upright posture so that you do not lean forward or tilt backward. Sitting upright effortlessly, you can enter Chan samadhi.
          </p>
          <p className="text-lg leading-relaxed mb-6 opacity-90">
            In the midst of samadhi, there is an unimaginable joy that is inexplicable and indescribable. Because it surpasses what your mind can imagine, it is described like this:
          </p>
        ...
        >
          ...
          <div className="bg-white/5 p-6 rounded-lg my-6">
            <p className="text-lg leading-relaxed mb-4 opacity-90 italic">
              People may praise us or ridicule us as they wish. In favorable or adverse conditions, we will advance vigorously. No suffering or joy will move our minds.
            </p>
        ...
        >
          ...
          <ol className="list-decimal list-inside space-y-4 mb-6 text-lg opacity-90">
            <li className="mb-2">
              <strong className="text-[#c9a050]">Heat.</strong> This warm energy comes as we sit in meditation.
            </li>
            <li className="mb-2">
              <strong className="text-[#c9a050]">Summit.</strong> That energy rises to the crown of our head as we continue to practice.
            </li>
            <li className="mb-2">
              <strong className="text-[#c9a050]">Patience.</strong> It becomes very difficult to be patient, but we must still be patient.
            </li>
            <li className="mb-2">
              <strong className="text-[#c9a050]">First in the World.</strong> We become a world-transcending great hero. If we want to attain these four stages, we must first learn to silence the mind. Our mind-consciousness must remain unmoving.
            </li>
          </ol>
          <p className="text-lg leading-relaxed mb-6 opacity-90">
