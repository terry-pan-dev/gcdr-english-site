      ...
      <div className="relative z-10">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-24 bg-[#1c1917]/80 backdrop-blur-sm rounded-t-3xl border-t border-[#c9a050]/20">
            ...
            <div className="space-y-12 text-lg font-light leading-relaxed text-stone-300 text-justify">
                ...
                <ExplanationBlock>
                    I didn't take part in that session for reciting the Great Bright Mantra. Why not? Because I wanted to let the participants follow their own free will. If I had pressured them into reciting, they would have been embarrassed not to recite. Then it would not really be them reciting, nor would it be me reciting. The recitation would have been done under pressure. That's why I chose not to take part in the session.
                </ExplanationBlock>
                ...
                <ExplanationBlock>
                    Since the ice is white, the poem is entitled "White Universe." That's to speak on a small scale. What about on a larger scale? The characters for "universe" in Chinese are <i>yu zhou</i>. <i>Yu</i> refers to the zenith and nadir, while <i>zhou</i> refers to the east, west, south, and north. Together the six directions comprise the universe. The universe of the six directions had turned completely white and there was no more darkness.
                </ExplanationBlock>
                ...
                <div className="my-12 p-8 border-l-2 border-[#c9a050] bg-[#2a2522]/50 italic text-stone-200 space-y-2">
                    <p><i>Ice in the sky, snow on the ground.</i></p>
                    <p><i>Numberless tiny bugs die in the cold or sleep in hibernation.</i></p>
                    <p><i>In the midst of stillness you should contemplate, and within movement you should investigate.</i></p>
                    <p><i>Dragons spar and tigers wrestle in continual playful sport;</i></p>
                    <p><i>Ghosts cry and spirits wail, their illusory transformations strange.</i></p>
                    <p><i>Ultimate truth transcends words;</i></p>
                    <p><i>Not thought about or talked about, you ought to advance with haste.</i></p>
                    <p><i>With great and small destroyed, with no inside or out,</i></p>
                    <p><i>It pervades every mote of dust and encompasses the Dharma Realm,</i></p>
                    <p><i>Complete, whole, and perfectly fused, interpenetrating without obstruction.</i></p>
                    <p><i>With two clenched fists, shatter the covering of empty space.</i></p>
                    <p><i>In one mouthful swallow the source of seas of Buddhalands.</i></p>
                    <p><i>With great compassion rescue all,</i></p>
                    <p><i>Sparing no blood or sweat, and never pause to rest!</i></p>
                </div>

                <ExplanationBlock>
                    "Although this verse is not as courageous as Yue Fei's "Crimson River," it's not too bad. The first line says:" <i>Ice in the sky, snow on the ground.</i> It describes how we worked hard amidst the cold–we were in an icebox. Although Gold Mountain Monastery is not a world-renowned place, people in the United States know that it is an icebox. In the icebox, there's ice in the sky and snow on the ground. The ice represents that it's cold–very, very cold.
                </ExplanationBlock>

                <ExplanationBlock>
                    At Gold Mountain Monastery, the building is cold and so are the people. Everyone who comes here says, "The people at Gold Mountain Monastery are very cold to people; they are not warm at all." So people who come here are all disappointed. "Ah! Those people are really frigid, not friendly at all." All the bugs in Gold Mountain Monastery die in the cold. The "ice" means it's icy cold, and "snow" means everything is frozen like ice and snow. "Ice in the sky and snow on the ground." This is pretty easy to understand, right?
                </ExplanationBlock>

                <ExplanationBlock>
                    "<i>N</i>umberless tiny bugs die in the cold." It's not known how many of these bugs there are. These tiny bugs are just our false thoughts and the germs in our bodies. Every person's body has bacteria and germs. Due to the presence of these organisms, our bodies want to consume vitamins, such as A, B, C, D, B12, and vitamins 100 or 1000.
                </ExplanationBlock>

                <ExplanationBlock>
                    "Die in the cold" means freeze to death. Since the people here don't take vitamins and yet still apply effort in such cold, these tiny organisms freeze to death. This kind of skill can eradicate all sorts of germs and infectious diseases. Not only does it cure skin diseases, it also freezes and kills the germs that transmit infectious diseases. Therefore, it says "Numberless tiny bugs die in the cold."
                </ExplanationBlock>

                <ExplanationBlock>
                    However, these creatures are skilled at hiding. They become stiff in the winter, as if they were frozen to death, but they aren’t really dead. The freeze temporarily causes them to become stiff and hard, but when the warm summer weather arrives, they come back to life. So it says: <i>or sleep in hibernation</i>. They hide away and go into hibernation, but when spring arrives they come back to life!
                </ExplanationBlock>

                <ExplanationBlock>
                    Buddhism advocates not killing, so we should try to avoid killing even germs. Thus, “Numberless tiny creatures die in the cold or sleep in hibernation.” They go into hibernation, and during that time they sleep. What does that symbolize? Their sleep symbolizes that when we are sitting in stillness and reciting the Six-Syllable Great Bright Mantra, we seem to enter samadhi and yet not enter samadhi. We seem to be reciting the Great Bright Mantra, but at the same time we seem to be in samadhi–that’s what is meant by “sleep in hibernation.” During our “hibernation” we should cultivate our thought.
                </ExplanationBlock>

                <ExplanationBlock>
                    Therefore the next verse says: <i>In the midst of stillness you should contemplate</i>. The mind is cold and calm, free of the seven emotions and six desires. Why is it free of them? Because it’s so cold! There is no energy for emotions and desires. Some creatures are frantically reciting, “It’s so cold! It’s so cold! It’s so cold!” These creatures are freezing so badly that they go into hibernation. In the midst of stillness you should contemplate: when the mind has calmed down, contemplate what this state is like. This refers to cultivators who enter a state of stillness and contemplate how the myriad things are all speaking the Dharma.
                </ExplanationBlock>

                <ExplanationBlock>
                    <i>And within movement you should investigate</i>. This refers to when you are moving about. Sometimes you sit and recite, and sometimes you walk and recite–never allowing the sound of the recitation to break off. In movement, contemplate the principles of the Buddha-dharma. To contemplate means to investigate, to look into the meditation topic. Even when you are moving, your mind should be clear and lucid, not muddled; whether sleeping or awake, you should not be confused. You should always be properly mindful; bring forth proper mindfulness and apply effort. Thus, you should investigate in movement.
                </ExplanationBlock>

                <ExplanationBlock>
                    At that time, what happens? Some demonic states may appear. What kind of demonic states? <i>Dragons spar and tigers wrestle in continual playful sport</i>. The dragons are riding the clouds and driving the fog while the tigers are diving into caves and leaping over boulders. They are frolicking and having fun. When these states appear, they dazzle your eyes. You see the dragons sparring and chase after that state: “I’m going to get on that dragon!” Then you enter a demonic state and become possessed by a demon.
                </ExplanationBlock>

                <ExplanationBlock>
                    When you see tigers wrestling, you are scared out of your wits. As soon as you let fear take hold, you also become vulnerable to demons. These are states that manifest in stillness. They are not worth mentioning. Just like the Fifty Skandha-demon States described in the <i>Shurangama Sutra</i>, these are illusory transformations, unreal states. So what should you do? You should “see as if not seeing, hear as if not hearing.”
                </ExplanationBlock>

                <ExplanationBlock>
                    <i>Ghosts cry and spirits wail, their illusory transformations strange</i>. At this time, you may hear ghosts howling, or perhaps you hear spirits wail. These illusory transformations are strange, and they are numerous beyond the description of words and perception of the mind. These are also illusory and false states. The ghosts are crying, “Oh! I am innocent! Someone did me in– please save me quickly! Recite more Sutras for me and rescue me. Have mercy on me! I won’t lose my temper anymore. I didn’t understand before…”
                </ExplanationBlock>
                ...
                <ExplanationBlock>
                    <i>Ultimate truth transcends words</i>. There is nothing to be said; there is neither right nor wrong, neither long nor short, neither good nor bad, and neither wholesome nor evil. There is nothing within the ultimate truth. "Originally, there is not a single thing. Where can the dust alight?" That is the ultimate truth. Within the ultimate truth, there is originally not a single thing. So where can the dust alight? There is nothing, so words are cut off. Let me tell you one more thing. This was the first poem I ever wrote in my life. I did not want to write any more after that because the obstacle of literature, the mark of literature, is not helpful at all. Therefore, I did not want to be caught up by the obstacle of literature or be attached to the mark of literature.
                </ExplanationBlock>

                <ExplanationBlock>
                    <i>Not thought about or talked about</i>. It is so ineffably wonderful that you cannot fathom it with your mind or discuss it with words. Your mouth wants to talk but words are lost; your mind wants to exploit it but thoughts are gone. It is so wonderful that no words can describe it. There’s no way to think about it either. The path of language is cut off, and the place of the mind’s activity is destroyed. It is impossible to speak of it or to reach it with thought. Even though it cannot be thought about or talked about, <i>you ought to advance with haste</i>. You still have to cultivate this kind of Dharma, because if you don’t, you’ll never obtain genuine skill.
                </ExplanationBlock>

                <ExplanationBlock>
                    <i>You ought to advance with haste!</i> Though it cannot be described with words, you still want to temper it with the skill of cultivation. Do not retreat; you want to advance vigorously and cultivate it. Don’t retreat. You shouldn’t fall into dull emptiness. If you say, “Oh! So I have nothing! This is inconceivable. Well, that’s the way it is. I’ll just go to sleep when I am sleepy and eat when I’m hungry, and when I die it will just be a tragic loss.” That is not the right attitude, either. That is also wrong because you are letting the time pass in vain.
                </ExplanationBlock>

                <ExplanationBlock>
                    <i>With great and small destroyed</i>. That which you are advancing towards with haste has no greatness and no smallness. <i>With no inside or out</i>. If you say this wonderful thing is outside, that’s not right. Nor is it inside, nor between inside and outside. Both great and small are destroyed–they are gone; there is no great and no small. Neither great nor small, neither inside nor out; one cultivates by oneself, understands by oneself, and makes arrangements for oneself. It is so great that nothing is outside, so small that nothing is inside. Thus, the great and the small are destroyed and inside and outside are gone; there is neither inside nor outside. It is wrong to say that it’s inside. It is just like what the <i>Shurangama Sutra</i> says*, that the mind is located neither inside nor outside. The Venerable Ananda was therefore confused.
                </ExplanationBlock>

                <ExplanationBlock>
                    <i>It pervades every mote of dust</i>. However, it is all pervasive. In each mote of dust, there is this Buddha-nature, this truth, and this seeing. <i>And encompasses the Dharma Realm</i>. Though the Dharma Realm is huge, it cannot encompass this wonder, this enlightened nature. It is said, “The emptiness born out of great enlightenment is just like a bubble in the ocean.” It cannot be described. <i>Complete, whole, and perfectly fused</i>. It is complete and whole, neither insufficient nor excessive.
                </ExplanationBlock>

                <ExplanationBlock>
                    You do not have the slightest bit of surplus, and I do not have the slightest bit of deficiency. It is not more on the part of the Buddha, nor is it less on the part of living beings. It is perfectly fair and just, without partiality or bias. This Dharma-nature is inherent in each of us; no one lacks it. It is not damaged and destroyed, but rather it is complete and perfectly fused, <i>interpenetrating without obstruction</i>, just like lamps. Each lamp has its own light, yet their lights are united. One lamp doesn’t say to another, “Look here, your light is too bright. I am jealous. I don’t want your light to be so bright. I’m going to destroy your light so that mine will show.” It’s not that way. Lights do not fight with each other. They shine upon each other and are mutually non-obstructing. Everyone cultivates and does not obstruct one another.
                </ExplanationBlock>

                <ExplanationBlock>
                    <i>With two clenched fists, shatter the covering of empty space</i>. With my two fists, I shatter empty space. The covering of empty space is gone, so that there is no empty space at all. There is nothing left. Heaven and earth are no longer to be seen anywhere. Everything has disappeared. <i>In one mouthful swallow the source of seas of Buddhalands</i>. In one mouthful, I swallow down the four great seas. I drink up all the waters in the four great seas, so that they all dry up. In one gulp, I swallow the entire world. Someone may say, "Doesn't that make you a monster?" Tell me, what is not a monster? To swallow the source of seas of Buddhalands in one gulp–this is the Buddha, who is neither great nor small, neither inside nor outside; who arranges his own birth and death at will.
                </ExplanationBlock>

                <ExplanationBlock>
                    <i>With great compassion rescue all</i>. What is to be done at this point? One must bring forth a mind of great compassion to universally rescue all living beings. Buddhas and Bodhisattvas rescue all living beings with great kindness and compassion. They bleed and sweat and don’t ever rest; despite the hardships they endure, they never complain like we do, saying, “I’m tired! I’m exhausted! I want to take a break.” Buddhas and Bodhisattvas forget their fatigue when they are saving living beings.
                </ExplanationBlock>

                <ExplanationBlock>
                    Therefore: <i>sparing no blood or sweat, and never pause to rest!</i> Applying effort in this way, people rested neither in the daytime nor at night. Seeing everyone applying effort so diligently, I wrote this poem in commemoration. Later on, I saw that people no longer applied effort and were very casual and lax. Maybe if I hadn’t written this poem, people would work harder. I wrote this poem to praise and commemorate them, and what happened? Later everyone just looked at each other and no one made vigorous progress anymore.
                </ExplanationBlock>
            </div>
