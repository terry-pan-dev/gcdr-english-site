...
export function Teachings() {
  const programs = [
    ...
    },
    {
      ...
      description:
        "A special program for children to learn Chinese language, Chinese calligraphy, Buddhist teachings, meditation, and moral values in a fun and engaging way",
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <div
            className="inline-block px-4 py-1 bg-amber-600/20 rounded-full mb-4"
            style={{ color: "#EBE9CF" }}
          >
            Teachings & Programs
          </div>
          ...
          {programs.map((program) => (
            ...
            >
              <div
                ...
                style={{ backgroundColor: "#c9a050", color: "#EBE9CF" }}
              >
        ...
        <div className="max-w-3xl mx-auto text-center">
          <blockquote
            ...
            style={{ color: "#EBE9CF", opacity: 0.9 }}
          >
