      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p style={{ color: '#EBE9CF', opacity: 0.7 }}>
              106 Bonogin Road<br />
              Bonogin, Queensland<br />
              4213 Australia
            </p>
          </div>
        </div>

        <div className="border-t border-white/10 pt-8 text-center" style={{ color: '#EBE9CF', opacity: 0.6 }}>
          <p>© {currentYear} Gold Coast Dharma Realm. All rights reserved.</p>
          <p className="mt-2 text-sm">May all beings be happy. May all beings be free from suffering.</p>
        </div>
      </div>
    </footer>
  );
