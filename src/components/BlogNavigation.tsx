      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-4">
        ...
        {previousPost ? (
          <motion.a
            ...
            className="group flex items-center gap-2 sm:gap-3 p-2 sm:p-4 transition-all duration-300 hover:shadow-md border cursor-pointer block"
            style={{
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <div className="text-[10px] sm:text-xs uppercase tracking-wider mb-0 sm:mb-0.5" style={{ color: '#c9a050' }}>
                Previous
              </div>
              <h3
                className="font-serif text-sm sm:text-base mb-0.5 sm:mb-1 line-clamp-1"
                style={{ color: '#1c1917', marginTop: '1rem', lineHeight: '1.8rem' }}
              >
        ...
        {nextPost ? (
          <motion.a
            ...
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.3 }}
            className="group flex items-center gap-2 sm:gap-3 p-2 sm:p-4 transition-all duration-300 hover:shadow-md border cursor-pointer block md:text-right"
            style={{
              backgroundColor: 'white',
              borderColor: '#c9a050',
              borderRadius: '0.5rem',
          ...
          >
            <div className="flex-1 min-w-0 md:order-2">
              <div className="text-[10px] sm:text-xs uppercase tracking-wider mb-0 sm:mb-0.5 md:text-right" style={{ color: '#c9a050' }}>
                Next
              </div>
              <h3
                className="font-serif text-sm sm:text-base mb-0.5 sm:mb-1 line-clamp-1"
